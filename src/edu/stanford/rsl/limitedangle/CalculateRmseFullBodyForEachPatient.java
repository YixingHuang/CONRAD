...
public class CalculateRmseFullBodyForEachPatient {
	public static void main(String[] args) throws IOException{
		...
		String wTvPath = "D:\\Tasks\\FAU4\\LimitedAngle\\Noisy3D\\150Degree\\wTV\\";
		String DcrPath = "D:\\Tasks\\FAU4\\LimitedAngle\\Noisy3D\\150Degree\\DCR\\";
...
//			nameWCE = path + "reconTruncated" + idx + ".tif";
			...
			nameWTV = wTvPath + idx + "\\40_FinalReconCL.tif";
			nameUNet = uNetPath + "UNetP" + idx + ".tif";
			nameDCR = DcrPath + idx + "\\20_FinalReconCL.tif";
