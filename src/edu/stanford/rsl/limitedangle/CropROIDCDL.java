...
public static void main(String[] args){
	...
	String mainPath = "D:\\Dropbox\\Dropbox\\TMI\\DCR_ID_DLP\\limited\\P3\\";
	
	String path1= mainPath + "GT3S196SW.png";
	String path2= mainPath + "FBP3S196SW.png";
	String path3= mainPath + "UNet3S196SW.png";
	String path4= mainPath + "DCR3S196SW.png";
	String path5= mainPath + "wTV3S196SW.png";
	...
	int width= 40, length = 40, xcor = 66, ycor = 120;
