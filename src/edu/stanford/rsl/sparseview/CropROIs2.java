...
public class CropROIs2 {
public static void main(String[] args){
	new ImageJ();


	String mainPath = "D:\\Dropbox\\Dropbox\\TMI\\DCR_ID_DLP\\truncation\\P18\\";
	
	String path1= mainPath + "GT18S150LW.png";
	String path2= mainPath + "FBP18S150LW.png";
	String path3= mainPath + "UNet18S150LW.png";
	String path4= mainPath + "DCR18S150LW.png";
	String path5= mainPath + "wTV18S150LW.png";
	...
	int width= 25, length = 25, xcor = 90, ycor = 2;
