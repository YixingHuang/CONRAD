...
public class GenerateReProjections {
	...
	public static void main(String[] args) throws Exception {
		...
		String path = "E:\\SiemensMarkerData\\UNetRecons\\"; //path for wTV data
		String pathRecon = "E:\\SiemensMarkerData\\recon\\";
		String savePath = "E:\\SiemensMarkerData\\reprojections2\\";
		String saveName1;
		GenerateReProjections obj = new GenerateReProjections(); 
		obj.initialGeometry();
...
//	}
	...
	public Grid3D getGroundTruthData(String path, int ii, boolean isTumor){
		...
		ImagePlus imp;
		Grid3D imgTemp;
		String pathTemp = path + "UNetP" + ii + ".tif";
		imp=IJ.openImage(pathTemp);
		imgTemp = ImageUtil.wrapImagePlus(imp);
