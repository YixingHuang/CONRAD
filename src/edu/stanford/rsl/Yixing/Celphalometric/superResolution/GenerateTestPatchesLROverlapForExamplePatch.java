...
public class GenerateTestPatchesLROverlapForExamplePatch {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		boolean isPix = false;
		GenerateTestPatchesLROverlapForExamplePatch obj = new GenerateTestPatchesLROverlapForExamplePatch();
		String path = "D:\\Tasks\\FAU4\\Cephalometric\\generatedCelps\\";
		String savePath;
		if(isPix)
			savePath = "D:\\Pix2pix\\tools\\superResolution\\testCelp\\";
		else
			savePath = "D:\\imageSuperResolutionV2_1\\low_res\\";
