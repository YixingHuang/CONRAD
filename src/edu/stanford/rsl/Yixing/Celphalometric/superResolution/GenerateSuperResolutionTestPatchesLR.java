...
/**
 * %%
x = [50         306         562         818        1074        1330        1586        1842];
x2 = [18         274         530         786        1042        1298        1554   1810];
x3 = [20 275 530 785 1040 1300 1555 1810];
x4 = [4    55   106   157   208   260   311 362];
idx = [0     0     1     2     3     4     5];
offset = [4    55    42    29    16     4    55 42];
 * @author Yixing Huang
 *
 */
public class GenerateSuperResolutionTestPatchesLR {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		GenerateSuperResolutionTestPatchesLR obj = new GenerateSuperResolutionTestPatchesLR();
		...
		int[] id = new int[] {0, 0, 1, 2, 3, 4, 4, 5};
		int[] offset = new int[] {4, 55,    42,    29,    16,     4,   55, 42};
		...
		for(int idx = 151; idx <=200; idx ++) {
            ...
            for(int i = 0; i < 7; i++) {
            	for(int j = 0; j < 8; j++ ) {
            		startX = id[i] * szIn + offset[i];
            		startY = id[j] * szIn + offset[j];
