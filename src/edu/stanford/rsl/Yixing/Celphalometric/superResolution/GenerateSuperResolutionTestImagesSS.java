...
public class GenerateSuperResolutionTestImagesSS {
	/**
	...
	public static void main(String[] args) throws IOException{
		new ImageJ();
		GenerateSuperResolutionTestImagesSS obj = new GenerateSuperResolutionTestImagesSS();
		String path = "D:\\Tasks\\FAU4\\MasterProjectOfFan\\RawImage\\Test1Data\\";
		String savePath = "D:\\Tasks\\FAU4\\Cephalometric\\SuperResolutionTestImages\\";
		String name;
		ImagePlus imp;
		Grid2D gt;
		Grid2D ds, us, dds;
		...
		int width = (size0[0] - 1)/factor3 + 1;
		int height = (size0[1] - 1)/factor3 + 1;
		us = new Grid2D(width, height);
		us.setSpacing(0.1 * factor3, 0.1 * factor3);
		us.setOrigin(origin0[0] + spacing0[0] * (factor3 - 1)/2.0, origin0[1] + spacing0[1] * (factor3 - 1)/2.0);
...
//			IJ.saveAs(imp, "png", imgNameIn);
			...
			imgNameIn2 = savePath + "data" + idx + "_us" + factor4 + ".png";
			imp.setDisplayRange(0, 255);
