...
public class GenerateSuperResolutionTrainingImages2QI3 {
	/**
	...
	public static void main(String[] args) throws IOException{
		new ImageJ();
		GenerateSuperResolutionTrainingImages2QI3 obj = new GenerateSuperResolutionTrainingImages2QI3();
		String path = "G:\\FAU4\\MasterProjectOfFan\\RawImage\\TrainingData\\";
		String savePath = "D:\\PIRM2018\\self_validation_HR\\";
		String name;
		ImagePlus imp;
		Grid2D gt;
		Grid2D ds, us, dds;
...
//			gt.clone().show("gt");
			ds = obj.cropImage(gt, 0, 0, 1935, 2200);
