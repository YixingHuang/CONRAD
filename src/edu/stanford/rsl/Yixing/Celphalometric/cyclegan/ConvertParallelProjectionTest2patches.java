...
public class ConvertParallelProjectionTest2patches {

	public static void main(String[] args) throws IOException{
		new ImageJ();
		ConvertParallelProjectionTest2patches obj = new ConvertParallelProjectionTest2patches();

		
		String inputPath = "D:\\Tasks\\FAU4\\Cephalometric\\";
		String savePathA = "D:\\CycleGAN-tensorflow\\datasets\\volume2cep2\\testA\\";
		...
		{
			inputName = inputPath + "parallelProjectionEnhanced.png";
    		...
    		patch3 = obj.cropImage(input, 89, 245, 256, 256);
    		...
    		patch4 = obj.cropImage(input, 245, 245, 256, 256);
