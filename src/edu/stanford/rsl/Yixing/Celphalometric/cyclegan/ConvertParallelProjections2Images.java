...
public class ConvertParallelProjections2Images {

	public static void main(String[] args) throws IOException{
		new ImageJ();
		ConvertParallelProjections2Images obj = new ConvertParallelProjections2Images();

		
		String inputPath = "D:\\Tasks\\FAU4\\Cephalometric\\parallelProjectionsEnhancedLowerAug\\";
		String savePathA = "D:\\CycleGAN-tensorflow\\datasets\\volume2cepImg\\trainA\\";
