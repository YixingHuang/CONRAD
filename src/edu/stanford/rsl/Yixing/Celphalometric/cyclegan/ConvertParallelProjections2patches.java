...
public class ConvertParallelProjections2patches {

	public static void main(String[] args) throws IOException{
		new ImageJ();
		ConvertParallelProjections2patches obj = new ConvertParallelProjections2patches();

		
		String inputPath = "D:\\Tasks\\FAU4\\Cephalometric\\parallelProjectionsEnhanced\\";
		String savePathA = "D:\\CycleGAN-tensorflow\\datasets\\volume2cep2\\trainA\\";
...
//			patch1 = obj.cropImage(input, 89, 256, 256, 256);
//			patch2 = obj.cropImage(input, 245, 256, 256, 256);
			patch1 = obj.cropImage(input, 89, 10, 256, 256);
			patch2 = obj.cropImage(input, 245, 10, 256, 256);
			
			imp = ImageUtil.wrapGrid(patch1, null);
			imp.setDisplayRange(0, 6);
