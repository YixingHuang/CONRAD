...
public class ConvertPix2pixPatchesToCycleGANPatchesWithFlipping {

	public static void main(String[] args) throws IOException{
		new ImageJ();
		ConvertPix2pixPatchesToCycleGANPatchesWithFlipping obj = new ConvertPix2pixPatchesToCycleGANPatchesWithFlipping();
...
//		String savePathB = "D:\\CycleGAN-tensorflow\\datasets\\p2cepRGB\\trainB\\";
		...
		String inputPath = "D:\\Pix2pix\\tools\\p2cep\\TestRGB4\\";
...
//			left = obj.fliplr(left);
//			right = obj.fliplr(right);
			left = obj.flipud(left);
			right = obj.flipud(right);
...
//			right = obj.fliplr(right);
			...
			imp = IJ.getImage();
    		outputName = savePathA + saveIdx + ".png";
			...
			IJ.run(imp,"Stack to RGB", "");
			imp = IJ.getImage();
    		outputName = savePathB + saveIdx + ".png";
    		IJ.saveAs(imp, "png", outputName);
    		imp.close();
