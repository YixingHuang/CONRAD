 ...
 *
 */
public class StitchOverlapPatchesForProjection2CepCycleGAN2 {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		boolean isPix = false;
		String path = "D:\\CycleGAN-tensorflow\\test\\p2cep\\";
		...
		int saveId = 1;
		int szIn = 256;
		StitchOverlapPatchesForProjection2CepCycleGAN2 obj = new StitchOverlapPatchesForProjection2CepCycleGAN2();
