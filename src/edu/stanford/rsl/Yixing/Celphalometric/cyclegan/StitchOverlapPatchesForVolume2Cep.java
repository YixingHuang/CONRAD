 ...
 *
 */
public class StitchOverlapPatchesForVolume2Cep {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		boolean isPix = false;
		String path = "D:\\CycleGAN-tensorflow\\test\\4QuandrantResults\\";
		...
		int saveId = 1;
		int szIn = 256;
		StitchOverlapPatchesForVolume2Cep obj = new StitchOverlapPatchesForVolume2Cep();
