...
public class GenerateCelphaloFromCTForAllTestPatients2 {
	public static void main(String[] args) throws IOException{
		...
		GenerateCelphaloFromCTForAllTestPatients2 obj = new GenerateCelphaloFromCTForAllTestPatients2();
...
//			p2.getGridOperator().removeNegative(p2);
			...
			Grid2D celpCombine3 = obj.sigmoidTransform3(celpCombine, 3f, 1.5f);
