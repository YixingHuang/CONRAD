...
public class GenerateCelphaloFromCTForAllTestPatients {
	public static void main(String[] args) throws IOException{
		...
		GenerateCelphaloFromCTForAllTestPatients obj = new GenerateCelphaloFromCTForAllTestPatients();
...
//		    IJ.saveAs(imp, "Tiff", name);
			...
			Grid2D celpCombine3 = obj.sigmoidTransform2(celpCombine, 2.8f, 1.5f);
