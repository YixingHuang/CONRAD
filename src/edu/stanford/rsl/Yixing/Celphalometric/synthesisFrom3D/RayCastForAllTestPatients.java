...
public class RayCastForAllTestPatients {
	public static void main(String[] args) throws IOException{
		...
		RayCastForAllTestPatients obj = new RayCastForAllTestPatients();
		String inputPath = "E:\\CQ500CTData\\completeHeadData\\";
		String outputPath = inputPath;
		String name;
		float s = 0.00002f;
		String savePath = "D:\\Tasks\\FAU4\\Cephalometric\\generatedCelps\\RayCast\\";
