...
public class GenerateCelphaloFromCT_Soft {
	public static void main(String[] args) throws IOException{
		...
		GenerateCelphaloFromCT_Soft obj = new GenerateCelphaloFromCT_Soft();
...
//			
			...
			Grid2D celpCombine4 = obj.sigmoidTransform3(celpCombine, 3.f, 1.5f);
			celpCombine4.clone().show("celpTahn4_" + idx);
			celpCombine4.getGridOperator().multiplyBy(celpCombine4, mask);
			celpCombine4.clone().show("afterMask4" + idx);
