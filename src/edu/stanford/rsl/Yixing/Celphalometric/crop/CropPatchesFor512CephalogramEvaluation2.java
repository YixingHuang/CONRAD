...
public class CropPatchesFor512CephalogramEvaluation2 {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		CropPatchesFor512CephalogramEvaluation2 obj = new CropPatchesFor512CephalogramEvaluation2();
		String path = "D:\\PIRM2018\\self_validation_HR\\images\\";
		String savePath = "D:\\PIRM2018\\self_validation_HR\\patches\\";
		String saveName;
		ImagePlus imp;
		String imgNameIn;
		int width = 128;
		...
		for(int idx = 1; idx <= 150; idx++)
		{
			...
			for(int jx = 0; jx <5; jx++)
				...
				{
					idx2 = idx * 100 + jx + jy * 5;
					offx = offset0 + 64 * jx;
					offy = offset02 + 64 * jy;
					img2 = obj.cropImage(img, offx, offy, width, height);
					imp = ImageUtil.wrapGrid(img2, null);
					imgNameIn = savePath + "data" + idx2 + ".png";
