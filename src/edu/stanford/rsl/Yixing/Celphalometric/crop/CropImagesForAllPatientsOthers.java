...
public class CropImagesForAllPatientsOthers {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		GenerateTestPatches obj = new GenerateTestPatches();
//		String path = "D:\\Tasks\\FAU4\\Cephalometric\\generatedCelps2Others\\";
//		String savePath = "D:\\Tasks\\FAU4\\Cephalometric\\generatedCelps2Others\\";
		String path = "D:\\Tasks\\FAU4\\Cephalometric\\generatedCelps2Others\\";
		String savePath = "D:\\Tasks\\FAU4\\Cephalometric\\generatedCelps2Others\\";
		String saveName;
		ImagePlus imp;
...
//			IJ.saveAs(imp, "png", saveName);
			...
			imp = ImageUtil.wrapGrid(img2, null);
			imp.setDisplayRange(0, 255);
			saveName = savePath +"RDN" + id  + "Crop.png";
			IJ.saveAs(imp, "png", saveName);
			
//			imgNameIn = path + "ps" + id + ".png";
//			imp = IJ.openImage(imgNameIn);
//			img = ImageUtil.wrapImagePlus(imp).getSubGrid(0);
//			img2 = cropImage(img, offset, offset2, width, height);
//			img2.clone().show("pix2pix");
//			imp = ImageUtil.wrapGrid(img2, null);
//			imp.setDisplayRange(0, 255);
//			saveName = savePath +"ps" + id  + "Crop.png";
//			IJ.saveAs(imp, "png", saveName);
		}
