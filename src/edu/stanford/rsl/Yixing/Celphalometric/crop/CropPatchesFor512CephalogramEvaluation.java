...
public class CropPatchesFor512CephalogramEvaluation {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		CropPatchesFor512CephalogramEvaluation obj = new CropPatchesFor512CephalogramEvaluation();
		String path = "D:\\PIRM2018\\your_results\\512RGB\\";
		String savePath = "D:\\PIRM2018\\your_results\\patches\\";
		String saveName;
		ImagePlus imp;
		String imgNameIn;
		int width = 128;
