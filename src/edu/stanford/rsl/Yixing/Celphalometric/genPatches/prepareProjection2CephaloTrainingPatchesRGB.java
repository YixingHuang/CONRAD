...
public class prepareProjection2CephaloTrainingPatchesRGB {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		boolean isP2Cep = true;
		prepareProjection2CephaloTrainingPatchesRGB obj = new prepareProjection2CephaloTrainingPatchesRGB();
//		String pathInput = "D:\\Tasks\\FAU4\\Cephalometric\\coneBeamProjectionsRGBLowerAug\\";
		String pathInput = "D:\\Tasks\\FAU4\\Cephalometric\\coneBeamProjectionsRGB\\";
		String pathOutput, trainingPath, valPath;
		if(isP2Cep)
		{
			pathOutput = "D:\\Tasks\\FAU4\\Cephalometric\\parallelCepsEnhanced\\"; //upperhalf
//			pathOutput = "D:\\Tasks\\FAU4\\Cephalometric\\parallelCepsLowerAugEnhanced\\"; //Lower half
			trainingPath = "D:\\Pix2pix\\tools\\p2cep\\trainRGB2\\";
			valPath = "D:\\Pix2pix\\tools\\p2cep\\valRGB2\\";
		}
		else
		{
