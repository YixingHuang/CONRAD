...
public class prepareProjection2CephaloTestPatchesRGB {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		boolean isP2Cep = true;
		prepareProjection2CephaloTestPatchesRGB obj = new prepareProjection2CephaloTestPatchesRGB();
...
//			pathOutput = "D:\\Tasks\\FAU4\\Cephalometric\\parallelCepsEnhanced\\"; //upperhalf
			...
			trainingPath = "D:\\Pix2pix\\tools\\p2cep\\TestRGB4\\";
			valPath = "D:\\Pix2pix\\tools\\p2cep\\valRGB4\\";
		}
		else
		{
...
//                	for(int c = 0; c < 3; c++)
//                		patchOut.setAtIndex(x, y, c, patchIn.getAtIndex(startX + x, startY + y, 0));
//                	patchOut = (Grid3D)patchIn.clone();
                }

            		//this is for merged images
            	merge = obj.mergeImages(patchIn, patchIn);
