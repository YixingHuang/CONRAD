...
public class testCephaloPatches1Channel {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		boolean isP2Cep = true;
		testCephaloPatches1Channel obj = new testCephaloPatches1Channel();
		...
		if(isP2Cep)
		{
			...
			trainingPath = "D:\\Pix2pix\\tools\\p2cep\\test4\\";
...
//			
            ...
            for(int x = 0; x < szIn; x++)
                for(int y = 0; y < szIn - ycut; y++){
                	patchIn.setAtIndex(x, y, input3D.getAtIndex(startX + x , startY  + y, 0));
