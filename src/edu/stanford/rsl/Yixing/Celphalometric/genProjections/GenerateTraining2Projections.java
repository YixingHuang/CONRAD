package edu.stanford.rsl.Yixing.Celphalometric.genProjections;
...
public class GenerateTraining2Projections {
...
//	public ConeBeamBackprojector cbbp;
	...
	public OpenCLGrid2D sinoCL2D, sinoCL2D2;
	...
	public static void main(String[] args) throws Exception{
		...
		GenerateTraining2Projections obj = new GenerateTraining2Projections();
		String inputPath = "E:\\CQ500CTData\\UpperHalf\\";
		String outputPath = "D:\\Tasks\\FAU4\\Cephalometric\\coneBeamProjections2\\";
...
//		Configuration.setGlobalConfiguration(conf);
	...
	public void getPerspectiveProjection() throws Exception {
		...
		cbp.projectRayDrivenCL2(sinoCL2D, volCL, 1);
		sinoCL2D.getDelegate().notifyDeviceChange();
		
//		sinoCL2D2 = new OpenCLGrid2D(new Grid2D(width, height));
//		sinoCL2D2.getDelegate().prepareForDeviceOperation();
//		cbp.projectRayDrivenCL2(sinoCL2D2, volCL, 1);
//		sinoCL2D2.getDelegate().notifyDeviceChange();
	}
