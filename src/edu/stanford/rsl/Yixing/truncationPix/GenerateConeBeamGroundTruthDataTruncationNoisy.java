...
public class GenerateConeBeamGroundTruthDataTruncationNoisy {
	...
	public static void main(String[] args) throws Exception {
		...
		String saveName1;
		GenerateConeBeamGroundTruthDataTruncationNoisy obj = new GenerateConeBeamGroundTruthDataTruncationNoisy(); 
		obj.initialGeometry();
		CLCommandQueue testqueue;
...
//			obj.artifactCL.release();
			...
			System.out.println(testqueue.getContext().getMemoryObjects().size()+ " memory objects before SART");
