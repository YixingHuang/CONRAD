 ...
 * P9, S122, x = 30, y=128, w=40
 * P2, S186, x=42, y=145, w=32
...
public class CropROIForEachPatientPnP {
...
//		String DcrPath = "E:\\FAU4\\TruncationCorrection\\NoiseFree3D\\DCR\\";
		...
		CropROIForEachPatientPnP obj = new CropROIForEachPatientPnP();
		ImagePlus imp1, imp;
		...
		String savePath = "D:\\Dropbox\\Dropbox\\TMI\\DCR_ID_DLP\\truncation\\P18Pix\\";
		String saveName;
...
//	            imp.close();	
//	            
				saveName = savePath + "gtRoi2" + idx + "S" + ii + ".png";
	            imp = ImageUtil.wrapGrid(gtRoi, null);
	            imp.setDisplayRange(0.4, 0.6);
	            IJ.saveAs(imp, "png", saveName);
	            imp.close();	
				saveName = savePath + "FBPDirectROI2" + idx + "S" + ii + ".png";
	            imp = ImageUtil.wrapGrid(directRoi, null);
	            imp.setDisplayRange(0.4, 0.6);
	            IJ.saveAs(imp, "png", saveName);
	            imp.close();	
				saveName = savePath + "FBPScaleROI2" + idx + "S" + ii + ".png";
	            imp = ImageUtil.wrapGrid(scaleRoi, null);
	            imp.setDisplayRange(0.4, 0.6);
	            IJ.saveAs(imp, "png", saveName);
	            imp.close();	
				saveName = savePath + "FBPSubROI2" + idx + "S" + ii + ".png";
	            imp = ImageUtil.wrapGrid(subRoi, null);
	            imp.setDisplayRange(0.4, 0.6);
	            IJ.saveAs(imp, "png", saveName);
	            imp.close();	
				saveName = savePath + "FistaROI2" + idx + "S" + ii + ".png";
	            imp = ImageUtil.wrapGrid(fistaRoi, null);
	            imp.setDisplayRange(0.4, 0.6);
	            IJ.saveAs(imp, "png", saveName);
	            imp.close();	
				saveName = savePath + "FistaProjROI2" + idx + "S" + ii + ".png";
	            imp = ImageUtil.wrapGrid(fistaProjRoi, null);
	            imp.setDisplayRange(0.4, 0.6);
	            IJ.saveAs(imp, "png", saveName);
	            imp.close();	
				saveName = savePath + "FistaWtvROI2" + idx + "S" + ii + ".png";
	            imp = ImageUtil.wrapGrid(fistaWtvRoi, null);
	            imp.setDisplayRange(0.4, 0.6);
	            IJ.saveAs(imp, "png", saveName);
	            imp.close();
	    		saveName = savePath + "FistaProjWtvROI2" + idx + "S" + ii + ".png";
