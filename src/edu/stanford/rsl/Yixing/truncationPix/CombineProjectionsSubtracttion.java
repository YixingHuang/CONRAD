...
public class CombineProjectionsSubtracttion {
	...
	public static void main(String[] args) throws Exception {
		...
		String savePath = "D:\\Tasks\\FAU4\\TruncationCorrection\\NoiseFree3D\\combinedProjectionsSubPix\\";
		String sinoPath = "D:\\Tasks\\FAU4\\TruncationCorrection\\NoiseFree3D\\projectionsGT\\";
		String saveName1;
		CombineProjectionsSubtracttion obj = new CombineProjectionsSubtracttion(); 
		obj.initialGeometry();
		...
		for(int i = 1; i <= 18; i++){
			...
			op.combineProjectionsSubtraction(obj.sinoCL, obj.sinoCL2, numTrunc);
