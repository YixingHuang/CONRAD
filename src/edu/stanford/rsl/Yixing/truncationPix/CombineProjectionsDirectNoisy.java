...
public class CombineProjectionsDirectNoisy {
...
//		String unetRecon = "D:\\Tasks\\FAU4\\TruncationCorrection\\Noisy3D\\UNetRecons\\";
//		String savePath = "D:\\Tasks\\FAU4\\TruncationCorrection\\Noisy3D\\combinedProjectionsScale\\";
//		String sinoPath = "D:\\Tasks\\FAU4\\TruncationCorrection\\Noisy3D\\projectionPwls\\";
		
		String unetRecon = "D:\\Tasks\\FAU4\\TruncationCorrection\\NoiseFree3D\\Pix2pixRecons\\";
		String savePath = "D:\\Tasks\\FAU4\\TruncationCorrection\\NoiseFree3D\\combineProjectionsDirectPix\\";
		String sinoPath = "D:\\Tasks\\FAU4\\TruncationCorrection\\NoiseFree3D\\projectionsGT\\";
		String saveName1;
		CombineProjectionsDirectNoisy obj = new CombineProjectionsDirectNoisy(); 
		obj.initialGeometry();
		...
		for(int i = 1; i <= 18; i++){
			...
			if(isPix2pix)
				pathTemp = unetRecon + "\\pix2pix" + i + ".tif";
			else
				pathTemp = unetRecon + "\\UNet" + i + ".tif";
			imp2 = IJ.openImage(pathTemp);
			imgTemp = ImageUtil.wrapImagePlus(imp2);
