...
public class CalculatePsnrFullForEachPatientPix2pix2 {
...
//				rmseDcr = getPSNR_Full(dcr2d, gt2d);
				rmsePix = getPSNR_Full(pix2d, gt2d);
//				rmseDirect = getPSNR_Full(direct2d, gt2d);
				rmseScale = getPSNR_Full(scale2d, gt2d);
//				rmseSub = getPSNR_Full(sub2d, gt2d);
//				rmseFista = getPSNR_Full(fista2d, gt2d);
				rmseFistaProj = getPSNR_Full(fistaProj2d, gt2d);
...
//	
	...
	private static double getPSNR_Full(Grid2D recon_data, Grid2D ref) {
		double err = 0;
		double maxV = 0;
