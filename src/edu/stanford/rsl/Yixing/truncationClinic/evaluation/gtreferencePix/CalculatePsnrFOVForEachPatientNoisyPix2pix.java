...
public class CalculatePsnrFOVForEachPatientNoisyPix2pix {
...
//				rmseFbp = RMSE_FullBody(fbp2d, gt2d);
				rmseWce = getPSNR_FOV(wce2d, gt2d);
				rmseWtv = getPSNR_FOV(wtv2d, gt2d);
				rmseUnet = getPSNR_FOV(unet2d, gt2d);
				rmseDcr = getPSNR_FOV(dcr2d, gt2d);
				rmsePix = getPSNR_FOV(pix2d, gt2d);
				rmseDirect = getPSNR_FOV(direct2d, gt2d);
				rmseScale = getPSNR_FOV(scale2d, gt2d);
				rmseSub = getPSNR_FOV(sub2d, gt2d);
				rmseFista = getPSNR_FOV(fista2d, gt2d);
				rmseFistaProj = getPSNR_FOV(fistaProj2d, gt2d);
				rmseFistaWtv = getPSNR_FOV(fistaWtv2d, gt2d);
				rmseFistaProjWtv = getPSNR_FOV(fistaProjWtv2d, gt2d);
