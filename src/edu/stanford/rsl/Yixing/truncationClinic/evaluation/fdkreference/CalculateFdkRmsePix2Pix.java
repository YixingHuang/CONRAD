...
public class CalculateFdkRmsePix2Pix {
...
//				rmseDcr = RMSE_FullBody(dcr2d, gt2d);
				rmsePix = RMSE_FullBody(pix2d, gt2d);
//				rmseDirect = RMSE_FullBody(direct2d, gt2d);
				rmseScale = RMSE_FullBody(scale2d, gt2d);
...
//				rmseFistaWtv = RMSE_FullBody(fistaWtv2d, gt2d);
				rmseFistaProjWtv = RMSE_FullBody(fistaProjWtv2d, gt2d);
