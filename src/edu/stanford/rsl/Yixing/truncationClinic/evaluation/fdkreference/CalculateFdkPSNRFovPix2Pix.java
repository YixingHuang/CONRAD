...
public class CalculateFdkPSNRFovPix2Pix {
...
//		String fistaWtvPath = "D:\\Tasks\\FAU4\\TruncationCorrection\\NoiseFree3D\\FISTA_wTV\\";
		String fistaProjWtvPath = "C:\\Tasks\\FAU4\\TruncationCorrection\\NoiseFree3D\\FISTA_Projection_Pix\\";
...
//				rmseDcr = RMSE_FullBody(dcr2d, gt2d);
				rmsePix = PSNR_FOV(pix2d, gt2d);
//				rmseDirect = RMSE_FullBody(direct2d, gt2d);
				rmseScale = PSNR_FOV(scale2d, gt2d);
...
//				rmseFistaWtv = RMSE_FullBody(fistaWtv2d, gt2d);
				rmseFistaProjWtv = PSNR_FOV(fistaProjWtv2d, gt2d);
...
//	}
//	
	private static double PSNR_FOV(Grid2D recon_data, Grid2D ref) {
		double maxV = 0;
		double err = 0;
