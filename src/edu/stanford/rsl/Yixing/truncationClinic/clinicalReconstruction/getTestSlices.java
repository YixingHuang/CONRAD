...
public class getTestSlices {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		getTestSlices obj = new getTestSlices();
		...
		String savePath = "D:\\Tasks\\FAU4\\TruncationCorrection\\clinical\\test512\\";
		...
		for(int patient = 1; patient <= 1; patient ++) {
			...
			for(int z = 0; z < wce.getSize()[2]; z++) {
				id = (patient) * 1000 + z;
				patchIn = (Grid2D)wce.getSubGrid(z).clone();
