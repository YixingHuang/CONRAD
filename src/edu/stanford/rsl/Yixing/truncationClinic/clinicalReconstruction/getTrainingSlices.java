...
public class getTrainingSlices {
	public static void main(String[] args) throws IOException{
		new ImageJ();
		getTrainingSlices obj = new getTrainingSlices();
		String pathInput = "D:\\Tasks\\FAU4\\TruncationCorrection\\clinical\\CQ500ReconsNoisy\\";
		...
		for(int patient = 0; patient <= 52; patient ++) {
			...
			for(int z = 15; z < 281; z = z + 10) {
				...
				patchOut = (Grid2D)artifact.getSubGrid(z).clone();
				if(patient <= 52) {
