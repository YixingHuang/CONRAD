...
public class FDKReconstructionFromDLExtrapolatedData {
	...
	public static void main(String[] args) throws Exception {
		...
		String path = "D:\\Tasks\\FAU4\\TruncationCorrection\\NoiseFree3D\\projectionsGT\\"; //path for wTV data
		String savePath = "C:\\Tasks\\FAU4\\TruncationCorrection\\NoiseFree3D\\FDK_GT\\";
